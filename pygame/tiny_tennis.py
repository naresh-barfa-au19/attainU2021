...
pygame.display.set_caption("Tiny Tennis by - NeshB")
...
while do_main:
    ...
    if(paddle1_y < 0):
        paddle1_y = 0
    elif(paddle1_y + paddle1_y > screen_height):
        paddle1_y =    paddle1_y

    if(paddle2_y < 0):
        paddle2_y = 0
    elif(paddle2_y + paddle2_y > screen_height):
        paddle2_y =   paddle2_y
    # left paddle
    ...
    net = pygame.draw.line(game_screen, yellow, (screen_width//2,5), (screen_width//2,screen_height))
